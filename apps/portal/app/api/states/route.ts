...
const DATA_PATH = path.join(process.cwd(), 'api', 'data', 'states.json')
...
export async function GET() {
  try {
    ...
    console.error('portal states route GET error', err)
...
export async function POST(req: Request) {
  ...
  try {
    ...
    console.error('portal states route POST error', err)
