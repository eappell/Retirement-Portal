    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:bg-gradient-to-br dark:from-slate-900 dark:to-slate-800 py-12 px-4">
      ...
      <div className="max-w-7xl mx-auto mb-12">
        <div className="flex justify-between items-center mb-8">
          <Link
            href="/dashboard"
            className="text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300 font-semibold flex items-center gap-2"
          >
            ← Back to Dashboard
          </Link>
        </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">What if I cancel my subscription?</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Do you offer annual billing?</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Need help choosing a plan?</h3>
              <p className="text-gray-600 dark:text-gray-300">
