...
export async function generateWithClaude(prompt) {
  ...
  // Try SDK first
  try {
    // Use the official @anthropic-ai/sdk package import; many projects use
    // @anthropic-ai/sdk (scoped package) instead of the legacy 'anthropic'
    // to avoid resolution issues on modern package managers and to follow
    // the official SDK naming.
